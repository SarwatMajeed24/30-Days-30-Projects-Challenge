...
// const candleColors = ['#FF5733', '#FFC300', '#DAF7A6', '#C70039', '#900C3F']
// const balloonColors = ['#FF5733', '#33FF57', '#5733FF', '#FFC300', '#DAF7A6']
...
//   return (
//     <div className="min-h-screen flex flex-col items-center justify-start p-4" style={{ backgroundColor: backgroundColor }}>
...
//         <h2 className="text-3xl font-semibold text-gray-600">Sarwat Majeed</h2>
//         <p className="text-xl text-gray-500">13th October</p>
//       </header>
...
//       >
//         <Card className="border-2 border-black shadow-md relative h-100 w-full p-1">
...
//             {/* Big cake icon in the center */}
//             <div className="flex justify-center items-center mb-4">
//               <FaBirthdayCake className="text-black w-48 h-48" />
//             </div>
...
// const candleColors = ['#FF5733', '#FFC300', '#DAF7A6', '#C70039', '#FF33A8']; // Changed last color
// const balloonColors = ['#FF5733', '#33FF57', '#5733FF', '#FFC300', '#FF33A8']; // Changed last color
// const cardColors = ['#FFEB3B', '#FF9800', '#FF5722', '#4CAF50', '#2196F3']; // New colors for card
// const confettiColors = ['#FF5733', '#FFC300', '#DAF7A6', '#C70039', '#900C3F', '#FF33A8', '#33A8FF'];
...
//       setCelebrating(false); // Celebration finished
//       if (audioRef.current) {
//         audioRef.current.pause(); // Pause the music when celebration finishes
//       }
//     }
...
//     setShowConfetti(true);
//     if (audioRef.current) {
//       audioRef.current.play(); // Play the music when celebration starts
//     }
...
//       <audio ref={audioRef} src="https://www.boomplay.com/songs/87938695?srModel=COPYLINK&srList=WEB" loop />
//     </div>
//   );
// }
'use client'; // Enables client-side rendering for this component
